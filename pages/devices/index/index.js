...
Page({
  ...
  data: {
    ...
    imgHeights: [],
    token: "",
    textTips: 'Tips，1.按右下角绿色按钮扫码添加设备，2.添加设备成功后，按“0#”唤醒设备WIFI后，打开手机WIFI并按设备列表中的WIFI图标直接连接设备WIFI，3.连接设备WIFI成功后，即可注册指纹、密码、IC卡，4.任何意见、建议均可点击左下角图标联系在线客服.',
    marqueePace: 1,//滚动速度
